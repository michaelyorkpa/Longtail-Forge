...
const cases = [
  ...
  ["two catalogues are crossed",
    'normalizeOptions(filterOptions.projects));',
    'normalizeOptions(filterOptions.clients));'],
  ["a catalogue takes the wrong all-label",
    '"user filter"), "All users", normalizeOptions(filterOptions.users));',
    '"user filter"), "All clients", normalizeOptions(filterOptions.users));'],
  ...
  ["the two vocabularies are read as labelled records",
    '"All record types", normalizeEnumOptions(filterOptions.recordTypes));',
    '"All record types", normalizeOptions(filterOptions.recordTypes));'],
