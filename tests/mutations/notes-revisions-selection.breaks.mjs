...
const cases = [
  ["error helper forwards opaque message", "safeNoteErrorMessage", 'typeof message === "string" && message ? message : fallback', 'message || fallback'],
  ["error helper discards readable message", "safeNoteErrorMessage", 'typeof message === "string" && message ? message : fallback', 'fallback'],
  ["error helper loses inherited message", "safeNoteErrorMessage", '"message" in caught', 'Object.hasOwn(caught, "message")'],
  ["error helper loses function message", "safeNoteErrorMessage", ' || typeof error === "function"', ''],
  ["error helper accepts empty message", "safeNoteErrorMessage", 'typeof message === "string" && message ?', 'typeof message === "string" ?'],
  ["error helper trims readable whitespace", "safeNoteErrorMessage", '&& message ? message : fallback', '&& message.trim() ? message : fallback'],
  ["error helper bypasses secure branch", "safeNoteErrorMessage", 'if (isSecureError(error))', 'if (false)'],
  ["secure classification loses function message", "isSecureError", ' || typeof error === "function"', ''],
  ["secure classification loses inherited message", "isSecureError", '"message" in caught', 'Object.hasOwn(caught, "message")'],
  ["secure classification loses raw error fallback", "isSecureError", 'message || error || ""', 'message || ""'],
  ["secure classification reverses message precedence", "isSecureError", 'message || error || ""', 'error || message || ""'],
  ["secure classification loses case folding", "isSecureError", '/i.test', '/.test'],
  ["secure classification loses cipher indicator", "isSecureError", '|cipher|', '|'],
  ...
  ["unreadable prompt returns before replacement", "renderDetailPrompt", 'prompt.textContent = typeof message === "string"', 'if (typeof message !== "string") return; prompt.textContent = typeof message === "string"'],
  ["prompt content changes", "renderDetailPrompt", 'typeof message === "string" ? message : "Note details could not be displayed."', '"wrong"'],
  ["prompt never replaces stale panel", "renderDetailPrompt", "requireNotesValue(detailPanel).replaceChildren(prompt);", "requireNotesValue(detailPanel);"],
  ["unreadable prompt is coerced instead of stated fallback", "renderDetailPrompt", 'typeof message === "string" ? message : "Note details could not be displayed."', 'String(message)'],
