...
const names = ["taskFocusFromCandidate", "refreshActiveTaskFocus", "consumeTaskFocusResumeNote", "refreshTaskFocusRelatedContext", "normalizeTaskFocusRelatedContext", "taskFocusRelatedContextState", "applyActiveTaskFocusTask", "preserveTaskFocusChecklistData", "syncTaskCandidateResumeNote", "candidateTaskId", "applyTaskFocusChecklistResult", "handleTaskFocusChecklistChange", "taskFocusTimerEligibility", "activeTaskFocusCandidate", "taskFocusTitle", "taskFocusContextLabel", "safeTaskFocusText", "safeCandidateText", "looksLikeRawId"];
