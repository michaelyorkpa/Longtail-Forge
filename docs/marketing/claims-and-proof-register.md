...
- **Classification:** `current` (shipped ≤ 0.33.13.5) · `preview` (near-term preview-readiness work) · `planned` (committed roadmap, not shipped) · `commercial-hypothesis` (later commercial/hosted, no commitment).
- **Verified at:** the app version / date the claim was last checked. Current baseline: **v0.33.13.5 · 2026-07-14**.
...
- **Verified at:** v0.33.13.5 · 2026-07-14.
...
- **Wording:** "Tasks, Time Tracking, Notes, Lists, Files, Search, Notifications, and Reporting are available today, alongside Clients/Projects, Dashboard, and Workbench."
- **Classification:** current.
...
- **Prohibited / risky:** don't add Tickets/KB/Creator Studio to this "available" list; don't claim invoicing, calendar, messaging, or email delivery (all future).
...
- **Prohibited / risky:** **Never** say "zero-knowledge," "end-to-end encrypted," "we can't read your data," or "unhackable." A configured server can decrypt; titles are plaintext metadata; losing the server key can make content unrecoverable.
- **Owner:** maintainer. **Refresh trigger:** any change to the encryption model or key handling.

### C-007 — Backup / restore
- **Wording:** "Tested backup and restore is planned as part of preview readiness."
- **Classification:** preview (roadmap 0.33.17.3, moved forward from 0.38.4).
- **Evidence:** [ROADMAP](../../ROADMAP.md) 0.33.17; [commercial-viability-plan](../licensing/commercial-viability-plan.md) Lane 1.
- **Verified at:** v0.33.13.5 · 2026-07-14.
- **Permitted locations:** roadmap/status sections only.
- **Prohibited / risky:** **Never** claim "automatic backup protection," "guaranteed backups," or "your data is safe." Do not imply backup/restore is shipped until 0.33.17 lands.
- **Owner:** maintainer. **Refresh trigger:** 0.33.17 backup/restore ships.

### C-008 — Internet exposure / production readiness
- **Wording:** "Internet-exposure hardening is active near-term roadmap work; until it ships, internet use is a private/technical preview."
- **Classification:** preview (roadmap 0.33.16).
- **Evidence:** [ROADMAP](../../ROADMAP.md) 0.33.16 / 0.33.17.
- **Verified at:** v0.33.13.5 · 2026-07-14.
- **Permitted locations:** status/trust/FAQ sections.
- **Prohibited / risky:** **Never** call the app "production-ready," "enterprise-grade," "hardened," or "safe for the public internet" until 0.33.16 hardening and 0.33.17 readiness have shipped. No pen-test/audit/compliance claims.
- **Owner:** maintainer. **Refresh trigger:** 0.33.16 / 0.33.17 completion.
...
- **Classification:** preview (per the 0.33.17 preview envelope).
- **Evidence:** [ROADMAP](../../ROADMAP.md) 0.33.17 (SQLite ~50 users / ~5–15 concurrent; PostgreSQL before SaaS).
- **Verified at:** v0.33.13.5 · 2026-07-14.
