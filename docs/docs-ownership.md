...
The ownership index covers Workbench, Dashboard, Tasks, Notes, Lists, Files, Search, Notifications, Tags, Time Tracking, Permissions, Database, module contracts, view-building/declarative surfaces, Public API, licensing, end-to-end smoke testing, and the release process.
