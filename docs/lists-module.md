...
This document describes the current Lists implementation as of 0.33.16.12. It is a developer handoff for the first-party `lists` module, not a product Help page and not a future Workbench or Knowledge Base design.
