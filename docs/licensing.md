...
| Public Terms and Privacy surfaces | Technical surface active; hosted review pending | A hosted instance is exposed to users | Maintain session-less footer-linked pages and neutral downstream-safe defaults. Each hosted operator must supply accurate installation-specific documents through runtime configuration. Raymond Tec preview/demo documents require attorney review and a private approval record before public exposure. |
...
or treat the technical surface as evidence of attorney approval.
