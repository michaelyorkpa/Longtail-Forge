...
- Runtime/operator contract files: `.env.example`, `.nvmrc`, `README.md`, `SECURITY.md`, `LICENSE`, this document, runtime configuration, operational security, preview deployment/Compose environment guidance, the reference internet-deployment/Caddy files, and SQLite small-office guidance.
