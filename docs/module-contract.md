...
There are no search-reserved manifest fields as of 0.32.6.7. `searchableTypes` is an active validated contract. Future extension data should be promoted deliberately with validator coverage instead of being accepted as arbitrary metadata.
