...
This document describes the current Notes implementation as of 0.33.5.29.1. It is a developer handoff for the first-party `notes` module, not a product Help page and not a Knowledge Base design.
