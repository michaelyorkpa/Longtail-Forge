...
function normalizeSearchDocument(searchableType, document = {}) {
  ...
  return {
    ...
    library_bucket: normalizeNullableString(document.libraryBucket || document.library_bucket),
    note_collection_id: normalizeNullableString(document.noteCollectionId || document.note_collection_id),
    collection_path: normalizeNullableString(document.collectionPath || document.collection_path),
