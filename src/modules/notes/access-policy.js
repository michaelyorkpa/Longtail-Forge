...
const NOTE_EVENT_TYPES = Object.freeze([
  ...
  eventType("note.linked", "Note Linked", "Emitted after a note is linked to another record."),
  eventType("note.unlinked", "Note Unlinked", "Emitted after a note link is removed."),
