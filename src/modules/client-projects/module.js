...
const clientProjectsModule = {
        ...
        rowActions: [
          {
            ...
            behavior: "client-projects.clients.create-child",
            requiredPermissions: ["clients.manage"],
            visibleWhen: { field: "canCreateChild", equals: true },
          },
          {
            id: "edit-client",
            label: "Edit Client",
            ...
            requiredPermissions: ["clients.manage"],
            visibleWhen: { field: "canManage", equals: true },
          },
        ],
  ...
  settings: [
    ...
    },
    {
      ...
      label: "Default Billing Rate ($/hour)",
      type: "text",
      placement: "workspace",
      default: "",
      inputmode: "decimal",
    ...
    },
    {
      ...
      terminology: {
        personal: { label: "Time Reporting Period" },
        family: { label: "Time Reporting Period" },
      },
    },
    {
      id: "billingPeriodStartDay",
      label: "Start Day",
      type: "number",
      placement: "workspace",
      default: 1,
      ...
      max: 28,
      step: 1,
      visibleWhen: { settingId: "billingPeriodType", equals: "custom" },
    },
  ],
  workbench: [],
  timerSources: [],
