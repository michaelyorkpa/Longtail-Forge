...
const developerExampleModule = {
  ...
  settings: [
    ...
    },
    {
      ...
      visibleWhen: { settingId: "developerExampleHintsEnabled", equals: true },
    },
    {
      id: "developerExampleHintsEnabled",
      label: "Example Detail Hints",
      type: "boolean",
      placement: "module",
      default: false,
      requiredPermissions: ["developer_example.view"],
      description: "Show optional detail hints in the developer example module.",
    },
  ],
  requiredPermissions: [
  ...
  taggableTypes: [
    {
      ...
      moduleId: "developer-example",
      label: "Developer Example",
      description: "Sample taggable type declaration for future tag documentation. Runtime assignments require the declared table to exist.",
      tableName: "developer_examples",
      idField: "developer_example_id",
      labelField: "title",
      workspaceField: "workspace_id",
      requiredReadPermission: "developer_example.view",
