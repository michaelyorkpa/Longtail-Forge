...
assert.match(roadmap, /0\.33\.5\.18\.10\.8\.5 is the most recently completed modal standardization closeout slice/, "Roadmap should report the current completed modal standardization closeout slice");
