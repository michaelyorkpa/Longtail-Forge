...
assert.match(tasksView, /css\/longtail-forge\.css\?v=20/, "Task reflow should cache-bust shared CSS");
...
assert.match(tasksModule, /version: "0\.33\.5\.13\.5"/, "Tasks module version should match the modal reflow release");
