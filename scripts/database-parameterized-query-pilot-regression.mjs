...
function assertPilotSourceShape() {
  ...
  assert.match(workspacesSource, /createWorkspace[\s\S]*BEGIN TRANSACTION/, "workspace creation should remain on compatibility helpers until the transaction slice");
