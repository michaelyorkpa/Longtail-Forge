...
function assertDocumentationContract() {
  ...
  assert.match(auditDocs, /Baseline-driven workflow[\s\S]*audit:params:check[\s\S]*Do not update the baseline in unrelated feature work/, "audit docs should use baseline enforcement instead of current parameter-binding count pins");
