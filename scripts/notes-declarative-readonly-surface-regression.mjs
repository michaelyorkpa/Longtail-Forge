...
assert.equal(packageJson.version, "0.33.6.6c", "package.json should report the current app version");
assert.equal(packageLock.version, "0.33.6.6c", "package-lock root should report the current app version");
assert.equal(packageLock.packages[""].version, "0.33.6.6c", "package-lock package entry should report the current app version");
