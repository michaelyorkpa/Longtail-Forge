...
assert.match(html, /css\/longtail-forge\.css\?v=49/, "Notes host should load the refreshed stylesheet");
assert.match(html, /js\/shared\/icons\.js\?v=4[\s\S]*js\/shared\/view-builder\.js\?v=11[\s\S]*js\/shared\/view-renderer\.js\?v=11[\s\S]*js\/notes\.js\?v=64/, "Notes host should load the icon helper, view builder, and renderer before the module adapter");
