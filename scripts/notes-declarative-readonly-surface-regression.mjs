...
assert.equal(packageJson.version, "0.33.5.27.26", "package.json should report the current app version");
assert.equal(packageLock.version, "0.33.5.27.26", "package-lock root should report the current app version");
assert.equal(packageLock.packages[""].version, "0.33.5.27.26", "package-lock package entry should report the current app version");
