...
assert.match(tasksView, /css\/longtail-forge\.css\?v=74[\s\S]*js\/shared\/view-builder\.js\?v=16[\s\S]*js\/shared\/view-renderer\.js\?v=13[\s\S]*js\/task-dialog\.js\?v=23[\s\S]*js\/tasks\.js\?v=22/, "Tasks host should load the lifecycle descriptor cache key");
