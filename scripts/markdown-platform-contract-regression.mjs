...
assert.equal(packageLock.version, "0.33.6.13z", "package-lock root version should report the current app version");
assert.equal(packageLock.packages[""].version, "0.33.6.13z", "package-lock package metadata should report the current app version");
