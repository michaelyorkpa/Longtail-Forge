...
assert.equal(packageLock.version, "0.33.5.18.8.4", "package-lock root version should report the current app version");
assert.equal(packageLock.packages[""].version, "0.33.5.18.8.4", "package-lock package metadata should report the current app version");
