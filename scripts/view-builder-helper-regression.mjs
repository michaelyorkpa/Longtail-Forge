...
assert.equal(packageJson.version, "0.33.5.15.3", "package.json should report the current helper line version");
assert.equal(packageLock.version, "0.33.5.15.3", "package-lock root should report the current helper line version");
assert.equal(packageLock.packages[""].version, "0.33.5.15.3", "package-lock package entry should report the current helper line version");
...
assert.match(viewContract, /As of 0\.33\.5\.15\.3/, "view contract should report helper implementation version");
