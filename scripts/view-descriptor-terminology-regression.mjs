...
assert.match(moduleContract, /Lists now uses a descriptor for its protected workspace read shell, item form fields, item table\/action placement, list-level workflow actions, linked-record picker\/row placement, and create\/edit modal shell/, "Module contract should document the current Lists descriptor boundary");
