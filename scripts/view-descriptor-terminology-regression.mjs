...
assert.match(moduleContract, /Lists conversion remains scheduled for later 0\.33\.5\.16 slices/, "Module contract should keep Lists conversion out of the terminology slice");
