...
assert.match(moduleContract, /browser rendering and app-shell delivery remain scheduled for later 0\.33\.5\.16 slices/, "Module contract should keep renderer work out of 0.33.5.16.3");
