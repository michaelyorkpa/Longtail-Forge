...
assert.match(moduleContract, /Lists now uses a descriptor for its protected workspace read shell while later slices still own Lists item rows, modal conversion, and workflow-action migration/, "Module contract should document the current Lists descriptor boundary");
