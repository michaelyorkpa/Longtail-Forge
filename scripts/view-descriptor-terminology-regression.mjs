...
assert.match(moduleContract, /App-shell descriptor delivery, data fetching, behavior registration, and Lists conversion remain scheduled for later 0\.33\.5\.16 slices/, "Module contract should keep descriptor delivery and live behavior out of the terminology slice");
