...
function assertStaticContract() {
  ...
  assert.match(roadmap, /0\.33\.5\.21\.9\.2[\s\S]*\[x\] Add a "Complete" \(checkmark\) button[\s\S]*\[x\] Clicking Complete in the modal saves pending edits/,
    "Roadmap should mark the task modal complete slice done");
