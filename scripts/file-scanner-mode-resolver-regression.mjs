...
function assertStaticContracts() {
  ...
  assert.match(runtimeDocs, /As of 0\.33\.5\.22\.11[\s\S]*`none`[\s\S]*`noop`[\s\S]*`clamd`[\s\S]*`clamscan`/, "runtime docs should formalize scanner modes");
  assert.match(moduleDocs, /As of 0\.33\.5\.22\.11[\s\S]*file\.scan[\s\S]*not_required/, "module docs should record none-mode file.scan disposition");
