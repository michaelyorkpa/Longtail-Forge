...
assert.match(clientsProjectsInventory, /Current as of 0\.33\.27\.5/, "Clients/Projects inventory should report its current version while preserving closeout history");
