...
assertHostScripts("views/protected/tasks.html", [/view-builder\.js\?v=16/, /view-renderer\.js\?v=13/, /task-dialog\.js\?v=23/, /tasks\.js\?v=21/]);
...
assert.match(roadmap, /Active cursor: `0\.33\.6`\. Completed `0\.33\.5\.29` is archived in `ROADMAP-ARCHIVE\.md`\./, "Roadmap should record the archived 0.33.5.29 handoff");
assert.match(roadmap, /## Version 0\.33\.6 - Dashboard and Workbench Formalization as Project hub and work center/, "Roadmap should advance after the completed database extraction contract and parameter-binding gap closeout branches");
