...
assert.match(clientsProjectsInventory, /Current as of 0\.33\.21\.11\.1/, "Clients/Projects inventory should report its current version while preserving closeout history");
