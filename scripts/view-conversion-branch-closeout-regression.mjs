...
assert.match(roadmap, /Active cursor: `0\.33\.6\.[^`]+`\. Completed work through `0\.33\.6\.[^`]+` is archived in `ROADMAP-ARCHIVE\.md`\./, "Roadmap should record the current archived handoff");
assert.match(roadmap, /## Remaining 0\.33\.6 Direction/, "Roadmap should advance after the completed database extraction contract and parameter-binding gap closeout branches");
