...
assert.match(clientsProjectsInventory, /Current as of 0\.33\.32\.24/, "Clients/Projects inventory should report its current version while preserving closeout history");
