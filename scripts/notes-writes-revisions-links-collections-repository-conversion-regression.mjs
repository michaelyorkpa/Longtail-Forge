...
function assertStaticContract() {
  ...
  assert.match(roadmap, /### Version 0\.33\.5\.27\.15 - Conversion wave: Notes writes, revisions, links, and collections[\s\S]*- \[x\] Convert the remaining `notes\/notes\.repo`[\s\S]*- \[x\] Preserve revision numbering[\s\S]*- \[x\] Update the burndown ratchet/, "roadmap should mark the Notes write conversion slice complete");
