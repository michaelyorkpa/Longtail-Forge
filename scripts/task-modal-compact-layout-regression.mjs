...
assert.match(tasksView, /<link rel="stylesheet" href="css\/longtail-forge\.css\?v=20">/, "Shared stylesheet cache bust should advance");
...
assert.match(tasksModule, /version: "0\.33\.5\.13\.5"/, "Tasks module version should match the current modal release");
