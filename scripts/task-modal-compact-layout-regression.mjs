...
assert.match(tasksView, /<script src="js\/task-dialog\.js\?v=16"><\/script>/, "Task dialog cache bust should advance");
assert.match(tasksView, /<link rel="stylesheet" href="css\/longtail-forge\.css\?v=66">/, "Shared stylesheet cache bust should advance");
