...
const currentTasksVersion = "0.33.5.21.7.6";
...
assert.match(tasksView, /<link rel="stylesheet" href="css\/longtail-forge\.css\?v=73">/, "Shared stylesheet cache bust should advance");
