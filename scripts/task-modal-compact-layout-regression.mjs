...
assert.match(tasksView, /<script src="js\/task-dialog\.js\?v=7"><\/script>/, "Task dialog cache bust should advance");
assert.match(tasksView, /<link rel="stylesheet" href="css\/longtail-forge\.css\?v=16">/, "Shared stylesheet cache bust should advance");
...
assert.match(tasksModule, /version: "0\.33\.5\.13\.1"/, "Tasks module version should match the current modal release");
