...
assert.match(tasksView, /<script src="js\/task-dialog\.js\?v=18"><\/script>/, "Task dialog cache bust should advance");
assert.match(tasksView, /<link rel="stylesheet" href="css\/longtail-forge\.css\?v=68">/, "Shared stylesheet cache bust should advance");
