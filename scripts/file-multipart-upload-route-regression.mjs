...
function assertStaticContracts() {
  ...
  assert.match(runtimeDocs, /As of 0\.33\.5\.22\.6[\s\S]*`POST \/api\/files\/upload` accepts one multipart file/, "runtime docs should mark the single-file multipart route active");
