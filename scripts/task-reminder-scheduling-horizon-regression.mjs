...
function assertStaticContract() {
  ...
  assert.match(tasksDocs, /current Tasks module behavior as of 0\.33\.5\.21\.7\.3/, "Tasks docs should report the current implementation version");
  ...
  assert.match(runtimeDocs, /As of 0\.33\.5\.21\.7\.3[\s\S]*30-day scheduling horizon[\s\S]*12-hour top-up sweep/, "runtime docs should document reminder horizon and sweep behavior");
