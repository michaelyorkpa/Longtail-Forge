...
async function assertStaticContracts() {
  ...
  assert.match(notesView, /js\/shared\/notification-subscriptions\.js\?v=1[\s\S]*js\/notes\.js\?v=70/, "Notes view should load notification subscriptions before Notes browser code");
