...
assert.match(clientsHtml, /js\/shared\/view-builder\.js\?v=2/);
assert.match(projectsHtml, /js\/shared\/view-builder\.js\?v=2/);
assert.match(workbenchHtml, /js\/shared\/view-builder\.js\?v=2/);
