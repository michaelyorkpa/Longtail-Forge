...
assert.match(clientsHtml, /clients-projects\.js\?v=18/);
assert.match(projectsHtml, /clients-projects\.js\?v=18/);
assert.match(workbenchHtml, /clients-projects\.js\?v=18/);
