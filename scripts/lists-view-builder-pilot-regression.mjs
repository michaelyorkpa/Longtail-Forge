...
assert.equal(packageJson.version, "0.33.5.15.6", "package.json should report the current view-builder line version");
assert.equal(packageLock.version, "0.33.5.15.6", "package-lock root should report the current view-builder line version");
assert.equal(packageLock.packages[""].version, "0.33.5.15.6", "package-lock package entry should report the current view-builder line version");
