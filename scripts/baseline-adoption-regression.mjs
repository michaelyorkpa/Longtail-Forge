...
ALTER TABLE note_library_collections DROP COLUMN security_transition_started_at;
ALTER TABLE note_library_collections DROP COLUMN security_transition_actor_user_id;
ALTER TABLE note_library_collections DROP COLUMN security_transition_job_id;
ALTER TABLE note_library_collections DROP COLUMN security_transition_version;
ALTER TABLE note_library_collections DROP COLUMN security_transition_action;
