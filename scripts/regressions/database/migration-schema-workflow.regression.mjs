...
try {
  ...
  assert.deepEqual(liveMigrations.map((migration) => migration.version), ["065", "066", "067", "068", "069", "070", "071", "072", "073", "074", "075", "076", "077", "078", "079", "080", "081", "082", "083", "084"]);
  assert.equal(planMigrationCreation("Add Widget Status", liveMigrations).fileName, "085_add_widget_status.sql");
