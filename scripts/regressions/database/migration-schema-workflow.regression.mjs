...
try {
  ...
  assert.match(liveSchema.sql, /security_transition_action TEXT NOT NULL DEFAULT 'none'/);
  ...
  assert.match(liveSchema.sql, /action_attempt/);
  assert.match(liveSchema.sql, /reason_class TEXT/);
