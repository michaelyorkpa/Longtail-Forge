...
assert.equal(packageJson.scripts.check, "npm run typecheck && npm run test:unit && eslint . --cache --cache-strategy content --cache-location .eslintcache && node scripts/run-regressions.mjs");
