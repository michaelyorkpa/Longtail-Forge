export const regressionMeta = Object.freeze({
  ...
  description: "Proves exact-demo outbound denial, environment and storage allowlists, internal networking, host firewall enforcement, and lifecycle-owned isolation smoke.",
  runMode: "static",
});
