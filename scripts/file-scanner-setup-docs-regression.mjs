...
assert.match(runtimeDocs, /As of 0\.33\.5\.22\.11[\s\S]*file-scanner-setup\.md/, "runtime docs should link ClamAV setup guidance");
...
assert.match(roadmap, /Completed 0\.33\.5\.22\.1 through 0\.33\.5\.22\.11 are archived in `ROADMAP-ARCHIVE\.md`/, "roadmap should archive completed storage/scanner setup slices after closeout");
assert.doesNotMatch(roadmap, /### Version 0\.33\.5\.22\.11 - Scanner setup docs and ClamAV closeout/, "live roadmap should not keep the completed scanner setup closeout slice open");
