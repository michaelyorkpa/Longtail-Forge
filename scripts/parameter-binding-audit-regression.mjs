...
const startupMaintenanceSliceVersion = appVersion;
...
assert.deepEqual(audit.totals, {
  boundOperationSites: 375,
  dbOperationSites: 425,
  helperCalls: 18,
  interpolatedOperationSites: 8,
