...
const ROUTE_RULES = Object.freeze([
  ...
  route([
    ...
    /^scripts\/release\//,
    /^scripts\/(?:bare-metal-deployment-smoke|build-container-image|build-runtime-artifact|bump-version|classify-pull-request-changes|container-deployment-smoke|version-literal|run-(?:regressions|slice-verification)|runtime-artifact-smoke|regression-(?:suite|runner|coverage|clean-clone)|generate-regression-manifest)/,
    /^scripts\/lib\/(?:changed-regression-runner|pull-request-change-classification|regression-change-routing|slice-verification-plan)\.mjs$/,
