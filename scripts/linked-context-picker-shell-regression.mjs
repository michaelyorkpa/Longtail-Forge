...
assert.match(roadmap, /0\.33\.5\.18\.6\.5\.2 - Framework Linked Context picker shell[\s\S]*\[x\] Build or formalize the shared picker UI shell/, "roadmap should mark the picker shell slice complete");
