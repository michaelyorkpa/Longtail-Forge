...
function assertStaticContracts() {
  ...
  assert.match(roadmap, /### Version 0\.33\.5\.22\.3 - Streaming write contract and multipart decision[\s\S]*- \[x\] Extend the storage adapter write contract for streaming/, "roadmap should mark the streaming write contract slice complete");
