...
function assertStaticContract() {
  ...
  assert.match(roadmap, /### Version 0\.33\.5\.27\.22 - Conversion wave: Notification preferences and subscriptions[\s\S]*- \[x\] Convert notification user preferences[\s\S]*- \[x\] Preserve per-user preferences[\s\S]*- \[x\] Update the burndown ratchet/, "roadmap should mark the Notifications preferences/subscriptions conversion slice complete");
