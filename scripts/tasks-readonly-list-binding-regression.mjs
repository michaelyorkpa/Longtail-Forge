...
assert.match(tasksView, /css\/longtail-forge\.css\?v=69[\s\S]*js\/shared\/view-builder\.js\?v=16[\s\S]*js\/shared\/view-renderer\.js\?v=12[\s\S]*js\/tasks\.js\?v=20/, "Tasks host should load the read-only list binding cache keys");
