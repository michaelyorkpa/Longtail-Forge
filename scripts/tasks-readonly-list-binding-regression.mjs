...
assert.match(tasksView, /css\/longtail-forge\.css\?v=73[\s\S]*js\/shared\/view-builder\.js\?v=16[\s\S]*js\/shared\/view-renderer\.js\?v=13[\s\S]*js\/tasks\.js\?v=21/, "Tasks host should load the read-only list binding cache keys");
