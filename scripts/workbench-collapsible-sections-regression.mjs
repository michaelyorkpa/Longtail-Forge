...
assert.match(workbenchHtml, /longtail-forge\.css\?v=27/, "Workbench should bump the shared stylesheet cache key for caret affordance styling");
assert.match(workbenchHtml, /workbench\.js\?v=22/, "Workbench should bump its script cache key for collapsible section state changes");
