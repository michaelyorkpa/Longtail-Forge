...
assert.match(
  inventoryDoc,
  /Current as of 0\.33\.32\.24[\s\S]*0\.33\.5\.18\.14\.4 Hierarchy Ordering and Reparent Safety[\s\S]*service-owned Projects read ordering[\s\S]*existing Client\/Project editors/,
