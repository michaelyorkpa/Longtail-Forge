...
async function assertStaticContracts() {
  ...
  assert.match(runtimeDocs, /As of 0\.33\.5\.22\.12, `LONGTAIL_STORAGE_PROVIDER` is consumed by Files upload writes/, "runtime docs should identify the live upload-write provider setting");
