...
assert.equal(packageLock.version, "0.33.5.18.11.8", "package-lock root should report the current app version");
assert.equal(packageLock.packages[""].version, "0.33.5.18.11.8", "package-lock package entry should report the current app version");
