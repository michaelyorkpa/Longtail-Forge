...
assert.match(workbenchHtml, /longtail-forge\.css\?v=34/, "Workbench should bump the stylesheet cache key after removing task-list styles");
assert.match(workbenchHtml, /workbench\.js\?v=33/, "Workbench should bump the script cache key after removing task-list rendering");
