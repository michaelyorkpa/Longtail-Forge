...
assert.match(docs, /406 discovered scripts/, "current docs should report the active registry");
...
assert.equal(REGRESSION_ENTRIES.length, 406, "auto-discovery should retain existing coverage plus private calendar feed and native SQLite compatibility proof");
assert.deepEqual(
