...
assert.match(docs, /416 discovered scripts/, "current docs should report the active registry");
...
assert.equal(REGRESSION_ENTRIES.length, 416, "auto-discovery should retain the complete public legal surface owner");
assert.deepEqual(
