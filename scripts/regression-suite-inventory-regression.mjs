...
assert.match(docs, /424 discovered scripts/, "current docs should report the active registry");
...
assert.equal(REGRESSION_ENTRIES.length, 424, "auto-discovery should retain the complete identifier, marketing, public legal, Client scope, role convergence, delegated-role browser, and sanitized-demo role-journey owners");
assert.deepEqual(
