...
function assertStaticContract() {
  ...
  assert.match(roadmap, /### Version 0\.33\.5\.27\.30 - Migration compatibility path[\s\S]*- \[x\] Review `src\/db\/migrations\.js`[\s\S]*- \[x\] Convert paths that can safely move[\s\S]*- \[x\] Account for dialect-sensitive migration statements[\s\S]*- \[x\] Update the burndown ratchet/, "roadmap should mark the migration compatibility slice complete");
