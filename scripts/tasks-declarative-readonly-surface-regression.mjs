...
assert.match(tasksView, /css\/longtail-forge\.css\?v=73/, "Tasks protected view should load the current stylesheet cache key");
assert.match(tasksView, /js\/shared\/view-builder\.js\?v=16[\s\S]*js\/shared\/view-renderer\.js\?v=13[\s\S]*js\/task-dialog\.js\?v=21[\s\S]*js\/tasks\.js\?v=21/, "Tasks protected view should load the renderer before the module adapter");
