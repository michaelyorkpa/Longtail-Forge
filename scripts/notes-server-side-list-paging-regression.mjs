...
function assertStaticContract() {
  ...
  assert.match(notesView, /css\/longtail-forge\.css\?v=56[\s\S]*js\/notes\.js\?v=72/, "Notes host should cache-bust list paging assets");
  assert.match(notesDocs, new RegExp(`current Notes implementation as of ${escapeRegExp("0.33.6.15.1")}`), "Notes docs should report the current implementation version");
