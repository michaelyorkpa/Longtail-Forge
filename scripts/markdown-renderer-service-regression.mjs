...
assert.equal(packageJson.version, "0.33.6.13z", "package.json should carry the Markdown renderer slice version");
assert.equal(packageLock.version, "0.33.6.13z", "package-lock root version should carry the Markdown renderer slice version");
assert.equal(packageLock.packages[""].version, "0.33.6.13z", "package-lock package metadata should carry the Markdown renderer slice version");
