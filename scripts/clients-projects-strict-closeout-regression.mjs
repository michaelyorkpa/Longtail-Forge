...
assert.match(inventoryDoc, /Current as of 0\.33\.32\.24[\s\S]*strict enforcement is active/, "Inventory should mark the current Clients/Projects strict guardrails active");
