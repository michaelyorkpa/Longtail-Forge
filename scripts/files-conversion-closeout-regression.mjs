...
assert.match(declarativeGuide, /Files is strict as of 0\.33\.5\.18\.12\.6[\s\S]*Clients\/Projects has active reported descriptors with framework-rendered read anatomy, shared module-action dispatch, and related-region helper adoption as of 0\.33\.5\.18\.14\.2/, "Declarative inventory should distinguish strict Files from reported Clients/Projects");
