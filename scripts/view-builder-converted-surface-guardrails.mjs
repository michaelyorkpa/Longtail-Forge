...
assert.match(listsHtml, /js\/shared\/view-builder\.js\?v=5[\s\S]*js\/lists\.js\?v=13/, "Lists should load view-builder before the converted module script");
...
for (const html of [clientsHtml, projectsHtml, workbenchHtml]) {
  ...
  assert.ok(
    html.indexOf("js/shared/view-builder.js") < html.indexOf("js/shared/view-renderer.js") &&
      html.indexOf("js/shared/view-renderer.js") < html.indexOf("clients-projects.js?v=18"),
