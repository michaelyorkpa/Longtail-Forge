...
assert.match(filesHtml, /js\/shared\/view-renderer\.js\?v=13[\s\S]*js\/shared\/file-preview\.js\?v=1[\s\S]*js\/files\.js\?v=14/, "Files host should load the compact-reset adapter after the renderer and shared preview");
