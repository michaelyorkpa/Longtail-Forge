...
function assertStaticDocumentation() {
  assert.match(auditDocs, /Baseline-driven workflow[\s\S]*audit:params:check[\s\S]*New violations[\s\S]*Do not update the baseline in unrelated feature work/, "audit docs should publish stable baseline enforcement instead of live count pins");
