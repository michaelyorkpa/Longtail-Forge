...
assert.match(clientsProjectsScript, /function renderClientProjectsReadSurface\(\)[\s\S]*renderSurface\(activeClientProjectsReadDescriptor, host\)/, "Clients/Projects read anatomy should mount through the shared renderer");
