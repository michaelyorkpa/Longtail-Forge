...
assert.match(extractFunctionSpan(taskDialog, "hasTaskEditPermission"), /tasks\.edit_all[\s\S]*tasks\.edit_own[\s\S]*created_by_user_id[\s\S]*assignee_ids/, "the header Block action should honor all-task and own-task edit permissions");
