...
assert.match(taskDialogScript, /icons\.decorateButton\(requireTaskIconButton\(fields\.notificationToggle\), \{ icon: "bell", label: "Follow task notifications", text: "", title: "Follow task notifications", iconOnly: true \}\)/, "Notification settings should render as a bell-only follow toggle when icons are available");
assert.match(taskDialogScript, /icons\.decorateButton\(requireTaskIconButton\(fields\.tagToggle\), \{ icon: "tag", label: "Task tags", text: "Tags", title: "Task tags", iconOnly: false \}\)/, "Tags footer action should include visible text");
assert.match(taskDialogScript, /icons\.decorateButton\(requireTaskIconButton\(fields\.fileToggle\), \{ icon: "file", label: "Task files", text: "Files", title: "Task files", iconOnly: false \}\)/, "Files footer action should include visible text");
assert.match(taskDialogScript, /icons\.decorateButton\(requireTaskIconButton\(fields\.copyLink\), \{ icon: "copy", label: "Copy task link", text: "Copy Link", title: "Copy task link", iconOnly: false \}\)/, "Copy Link should include visible text");
assert.match(taskDialogScript, /icons\.decorateButton\(requireTaskIconButton\(fields\.cancel\), \{ icon: "close", label: "Cancel", text: "", title: "Cancel", iconOnly: true \}\)/, "Cancel should be icon-only");
assert.match(taskDialogScript, /icons\.decorateButton\(requireTaskIconButton\(fields\.save\), \{ icon: "save", label: "Save task", text: "", title: "Save task", iconOnly: true \}\)/, "Save Task should be icon-only");
