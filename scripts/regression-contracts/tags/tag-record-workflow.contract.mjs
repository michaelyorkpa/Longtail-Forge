...
assert.match(clientsProjects, /tagSurface\.mountPicker\(container,\s*\{[\s\S]*tags:\s*tagOptions,[\s\S]*selectedTags:\s*tags/, "Clients/Projects workflows must mount the shared inline tag picker with origin-aware selected tags");
