...
assert.match(notesScript, /copyLinkButton = document\.querySelector\("\[data-copy-note-link\]"\)[\s\S]*copyLinkButton\?\.addEventListener\("click", copyCurrentNoteLink\)/, "Notes Copy Link should have a module-owned click handler");
