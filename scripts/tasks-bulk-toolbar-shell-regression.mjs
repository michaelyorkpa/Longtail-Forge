...
assert.match(tasksView, /css\/longtail-forge\.css\?v=60[\s\S]*js\/shared\/view-builder\.js\?v=13[\s\S]*js\/shared\/view-renderer\.js\?v=12[\s\S]*js\/tasks\.js\?v=16/, "Tasks host should load the bulk toolbar shell cache keys");
