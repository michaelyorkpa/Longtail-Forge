...
assert.match(tasksView, /js\/shared\/view-builder\.js\?v=16[\s\S]*js\/task-dialog\.js\?v=23[\s\S]*js\/tasks\.js\?v=22/, "Tasks host should advance cache keys for the touched view helper and task dialog assets");
