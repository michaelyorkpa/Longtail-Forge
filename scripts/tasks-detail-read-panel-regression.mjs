...
assert.match(tasksView, /js\/shared\/view-builder\.js\?v=16[\s\S]*js\/task-dialog\.js\?v=23[\s\S]*js\/tasks\.js\?v=21/, "Tasks host should advance cache keys for the touched view helper and task dialog assets");
assert.match(workbenchView, /js\/shared\/view-builder\.js\?v=16[\s\S]*js\/task-dialog\.js\?v=23/, "Workbench host should load the updated shared view helper before the Task dialog");
