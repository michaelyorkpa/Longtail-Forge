...
assert.equal(packageJson.version, "0.33.5.17.5", "package.json should report the current app version");
assert.equal(packageLock.version, "0.33.5.17.5", "package-lock root should report the current app version");
assert.equal(packageLock.packages[""].version, "0.33.5.17.5", "package-lock package entry should report the current app version");
...
assert.match(listsModule, /layout:\s*"split-list-detail"/, "Lists descriptor should own the split layout");
...
assert.match(listsModule, /indexPanel:\s*\{[\s\S]*titleKey:\s*"plural"/, "Lists descriptor should declare the selector/index panel");
...
assert.match(decisions, /## Version 0\.33\.5\.16\.9/, "Decisions should include Lists declarative proof version");
