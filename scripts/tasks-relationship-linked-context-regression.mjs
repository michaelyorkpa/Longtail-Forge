...
assert.match(tasksView, /js\/shared\/notes-linked-panel\.js\?v=2[\s\S]*js\/shared\/view-builder\.js\?v=16[\s\S]*js\/task-dialog\.js\?v=23[\s\S]*js\/tasks\.js\?v=21/, "Tasks host should load refreshed linked-context, framework helper, and task row assets");
assert.match(workbenchView, /js\/shared\/notes-linked-panel\.js\?v=2[\s\S]*js\/shared\/view-builder\.js\?v=16[\s\S]*js\/task-dialog\.js\?v=23/, "Workbench host should load refreshed linked-context and framework helper assets before the shared Task dialog");
