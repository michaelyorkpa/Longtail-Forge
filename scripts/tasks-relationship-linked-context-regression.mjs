...
assert.match(tasksView, /js\/shared\/notes-linked-panel\.js\?v=2[\s\S]*js\/shared\/view-builder\.js\?v=16[\s\S]*js\/task-dialog\.js\?v=23[\s\S]*js\/tasks\.js\?v=22/, "Tasks host should load refreshed linked-context, framework helper, and task row assets");
