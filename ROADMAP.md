...
**Execution order.** `0.33.33.32.28.2`, `0.33.33.32.28.3.1`, `0.33.33.32.28.3.2`, `0.33.33.32.28.3.3`, `0.33.33.32.28.4.1`, `0.33.33.32.28.4`, `0.33.33.32.28.4.2`, `0.33.33.32.28.4.3`, and `0.33.33.32.28.3` have archived, closing the boundary work entirely. Next are the two remaining `0.33.33.32.28.4*` helper children, and **`0.33.33.32.28.1` last**. The numbering is historical, not an execution order; `0.33.33.32.28.1` is not renumbered because it is referenced by every closeout rule in this rollup.
