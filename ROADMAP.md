...
**Execution order.** `0.33.33.32.28.2`, `0.33.33.32.28.3.1`, `0.33.33.32.28.3.2`, `0.33.33.32.28.3.3`, `0.33.33.32.28.4.1`, `0.33.33.32.28.4`, `0.33.33.32.28.4.2`, `0.33.33.32.28.4.3`, `0.33.33.32.28.3`, `0.33.33.32.28.4.4`, and `0.33.33.32.28.4.5` have archived, closing the boundary work and the source-slicing consolidation entirely. **`0.33.33.32.28.1` is the only child left.** The numbering is historical, not an execution order; `0.33.33.32.28.1` is not renumbered because it is referenced by every closeout rule in this rollup.
...
**Source-slicing consolidation: closed.** Seventy-three owners cut function regions through the three published helpers in `scripts/test-support/source-scan.mjs` - `extractFunctionBlock` (declaration through its matching close), `extractFunctionBody` (opening brace through its close), and `extractFunctionSpan` (declaration through the next top-level function, or the end of the source). **Exactly five local readers remain**, all in Workbench contract modules, all returning a body *without* its braces - a fourth region that five definitions do not justify publishing. `framework.full-strict-governance` names those five and asserts that **no script anywhere else may define a function-region extractor**, so a new owner cannot be added without being migrated.
