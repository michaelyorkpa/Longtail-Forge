...
**Reconciliation: the estate is 28 classic-script owners, each in exactly one child, no duplicate and no orphan. `0.33.33.33.1` through `0.33.33.33.5` have taken 19; the table below is the remaining 9. `dashboard.entry.js` and `tasks-dashboard.js` are native ES modules and are not in the estate.**

| Child | Load surface | Owners | Lines | Diagnostics |
| --- | --- | --- | --- | --- |
| `.33.6` | Record module page controllers | 6 | 16,478 | 3,626 |
| `.33.7` | Time tracking and orchestration controllers | 3 | 6,404 | 1,309 |
| **Remaining** | | **9** | **22,882** | **4,935** |
