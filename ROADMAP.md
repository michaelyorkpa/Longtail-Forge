...
| Codex | `0.33.33.42.44` | `workbench.js` — checked-DOM adoption completed locally (0 DOM); Inspector candidate remains (ruled), then extraction | 1 owned |
