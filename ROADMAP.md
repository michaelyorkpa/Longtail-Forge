...
The unchecked-boundary figure was confirmed unchanged at **77 sites across 55 owners**. `0.33.33.32.28.3.2` and `0.33.33.32.28.3.1` have since closed 24 of them across 16 owners, leaving **53 across 39** for the two remaining boundary children.

**Execution order.** `0.33.33.32.28.2`, `0.33.33.32.28.3.1`, and `0.33.33.32.28.3.2` have archived. Next are the two remaining `0.33.33.32.28.3*` boundary children, then the six `0.33.33.32.28.4*` helper children, and **`0.33.33.32.28.1` last**. The numbering is historical, not an execution order; `0.33.33.32.28.1` is not renumbered because it is referenced by every closeout rule in this rollup.
