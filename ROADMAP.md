...
| Claude | `0.33.33.38.3.9` | `clients-projects.js` — shared checked-DOM contract published and adopted at all 17 lookups; its 10 remaining `dom` are not lookups; `lists.js` adoption next | 143 |
